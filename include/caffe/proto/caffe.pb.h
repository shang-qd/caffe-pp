...
enum SolverParameter_SolverMode {
  ...
  SolverParameter_SolverMode_CL = 2
};
...
const SolverParameter_SolverMode SolverParameter_SolverMode_SolverMode_MAX = SolverParameter_SolverMode_CL;
...
class SolverParameter : public ::google::protobuf::Message {
 public:
  ...
  static const SolverMode CL = SolverParameter_SolverMode_CL;
